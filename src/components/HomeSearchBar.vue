<template>
	<div class="home-search-bar">
		<input class="input-search"  v-model="searchText" @keydown.enter="doSearch" @keyup="searchData(searchText)"/>
		...
		<span class="welcome" v-show="searchText == '新兵训练营' && a" v-on:click="a=flase"> <p>welcome</p></span>
	</div>
</template>
...
@keyframes welcome 
{
	0%   {left:-450px; top:-200px;}
	25%  {left:-200px; top:200px;}
	50%  {left:100px; top:-200px; }
	75%  {left:300px; top:200px; }
